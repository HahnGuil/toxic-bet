...
public class MatchController implements MatchApi {
     ...
     * 2 - IMPUTAR O RESULTADO NÃO INICIADO QUANDO CRIAR UMA PARTIDA
     * 3 - MUDAR O DTO DE RESPOSTA DO GET ALL PARA UM QUE TRAGA O NOME DOS TIMES E NÃO OS ID
     * 4 - IMPLEMENTAR NO TEAM SERVER UM FLUXO NÃO BLOQUEANTE PARA PEGAR OS NOMES
     */
